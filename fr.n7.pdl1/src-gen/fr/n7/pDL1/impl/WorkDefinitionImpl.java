 ...
 *   <li>{@link fr.n7.pDL1.impl.WorkDefinitionImpl#getNeed <em>Need</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition
{
  ...
  public EList<Need> getNeed()
  {
    if (need == null)
    {
      need = new EObjectContainmentEList<Need>(Need.class, this, PDL1Package.WORK_DEFINITION__NEED);
    }
    return need;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PDL1Package.WORK_DEFINITION__NEED:

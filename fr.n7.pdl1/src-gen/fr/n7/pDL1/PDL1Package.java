...
public interface PDL1Package extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link fr.n7.pDL1.impl.NeedImpl <em>Need</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see fr.n7.pDL1.impl.NeedImpl
   * @see fr.n7.pDL1.impl.PDL1PackageImpl#getNeed()
   * @generated
   */
  int NEED = 5;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link fr.n7.pDL1.WorkDefinition#getNeed <em>Need</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Need</em>'.
   * @see fr.n7.pDL1.WorkDefinition#getNeed()
   * @see #getWorkDefinition()
   * @generated
   */
  ...
  /**
   * Returns the meta object for class '{@link fr.n7.pDL1.Need <em>Need</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.n7.pDL1.Need#getNbResources <em>Nb Resources</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Nb Resources</em>'.
   * @see fr.n7.pDL1.Need#getNbResources()
   * @see #getNeed()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the reference '{@link fr.n7.pDL1.Need#getResource <em>Resource</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Resource</em>'.
   * @see fr.n7.pDL1.Need#getResource()
   * @see #getNeed()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.n7.pDL1.Resource#getNbAvailableResources <em>Nb Available Resources</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Nb Available Resources</em>'.
   * @see fr.n7.pDL1.Resource#getNbAvailableResources()
   * @see #getResource()
   * @generated
   */
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link fr.n7.pDL1.impl.NeedImpl <em>Need</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see fr.n7.pDL1.impl.NeedImpl
     * @see fr.n7.pDL1.impl.PDL1PackageImpl#getNeed()
